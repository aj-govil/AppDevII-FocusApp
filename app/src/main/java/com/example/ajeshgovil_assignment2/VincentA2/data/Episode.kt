...
val episodes = listOf(
    ...
    Episode(R.drawable.felina,"S5 E16","Felina",
    ...
    Episode(R.drawable.faceoff,"S4 E13","Face Off",
    ...
    Episode(R.drawable.deadfright,"S5 E5","Dead Fright",
    ...
    Episode(R.drawable.crawlspace,"S4 E11","Crawl Space",
    ...
    Episode(R.drawable.fullmeasure,"S3 E13","Full Measure",
    ...
    Episode(R.drawable.confessions,"S5 E11","Confessions",
    ...
    Episode(R.drawable.saymyname,"S5 E7","Say My Name",
